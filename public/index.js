...
window.onload = function () {
  ...
  let html_content = `<div id="iframe-wrapper" style="height:100%; max-width: 400px; width: 100%; padding:10px;"
  class ="zIndexInfinite fixed right-0 bottom-0 h-full app-inActive" >
  <iframe
    id="iframe-bot-botId"
    src="http://localhost:3000/preview/${botIdValue}?color=${button_color.substring(1)}"
    width="100%" height="100%"
  />
</div>
`
  let html_button = `<div class="bot-right bot-eb-trigger bot-popup bot-active" id="eb-bot-trigger" onclick="toggleIframe">
<span
